...
using Xamarin.Forms;
using SmartRecord.Views.Controls;
using SmartRecord.Views.ViewModels.Login1;

namespace SmartRecord.Views.Converters
{
    /// <summary>
    ...
    public class ErrorValidationColorConverter : IValueConverter
    {
        ...
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            LoginViewModel bindingContext = emailEntry.BindingContext as LoginViewModel;
